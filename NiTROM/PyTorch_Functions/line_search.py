...
class LineSearch:
    def __init__(
        ...
        *,
        ...
        self.allow_increase_factor = float(allow_increase_factor) if allow_increase_factor is not None else None
    ...
    def search(self, cost_fn, params, descent_direction, current_loss, grad_norm_sq):
        ...
        def _eval(alpha_local):
            trial_params = [p - alpha_local * d for p, d in zip(params, descent_direction)]
