...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_cgl_main.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_cgl_main.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 41-68
...
.. GENERATED FROM PYTHON SOURCE LINES 219-260
...
.. _sphx_glr_download_auto_examples_cgl_main.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: main.zip <main.zip>`
