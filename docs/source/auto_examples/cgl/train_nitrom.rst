...
.. "auto_examples/cgl/train_nitrom.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_cgl_train_nitrom.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_cgl_train_nitrom.py:
...
.. _sphx_glr_download_auto_examples_cgl_train_nitrom.py:
