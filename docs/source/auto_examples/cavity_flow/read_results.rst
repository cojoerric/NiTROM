...
.. "auto_examples/cavity_flow/read_results.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_cavity_flow_read_results.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_cavity_flow_read_results.py:
...
.. _sphx_glr_download_auto_examples_cavity_flow_read_results.py:
