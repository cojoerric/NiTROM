...
.. "auto_examples/cavity_flow/time_steppers.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_cavity_flow_time_steppers.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_cavity_flow_time_steppers.py:
...
.. _sphx_glr_download_auto_examples_cavity_flow_time_steppers.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: time_steppers.ipynb <time_steppers.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: time_steppers.py <time_steppers.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: time_steppers.zip <time_steppers.zip>`
