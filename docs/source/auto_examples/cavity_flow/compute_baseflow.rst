...
.. "auto_examples/cavity_flow/compute_baseflow.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_cavity_flow_compute_baseflow.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_cavity_flow_compute_baseflow.py:
...
.. _sphx_glr_download_auto_examples_cavity_flow_compute_baseflow.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: compute_baseflow.ipynb <compute_baseflow.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: compute_baseflow.py <compute_baseflow.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: compute_baseflow.zip <compute_baseflow.zip>`
