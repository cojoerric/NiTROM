...
from NiTROM.Optimization_Functions import classes, opinf_models as model
...
A_oi = model.params.A2.detach()
H_oi = model.params.A3.detach()
...
plt.legend()
plt.tight_layout()
plt.savefig('figures/error_20_opinf')